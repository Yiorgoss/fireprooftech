...
<div class="pt[100px] relative -mt-[100px] w-full overflow-hidden bg-foreground">
	...
	<div class="overflow-hidden bg-off-blue px-14">
		<div
			class="mx-auto -mb-[15%] -mt-[15%] flex aspect-square min-w-[90%] items-center justify-center rounded-full bg-foreground text-background"
		>
			<div class="flex aspect-square h-[70.7%] w-[70.7%] flex-col justify-center">
				<h2 class="text-center font-playfair text-4xl uppercase md:text-5xl">
